...
export default function Header({ count }) {
  return (
    <header className="relative z-10 flex items-center justify-between gap-4 px-5 py-3 sm:px-7">
      <div className="flex items-baseline gap-3">
        <span className="text-[15px] font-bold tracking-tight sm:text-[17px]">
          the <span className="flame-text">wall</span>
        </span>
      ...
      <div className="flex items-center gap-4 text-[11px] text-ink-soft sm:gap-5">
